...
(function(window, builder)
{
	 ...
	 * @param {Number} Start - start character of Range in Element
	 * @param {Number} End - end character of Range in Element
	 * @constructor
	 */
	...
	* @typeofeditors ["CDE"]
	* @param {Number} Start - start character in element
	* @param {Number} End - end character in element 
	* @return {ApiRange}
	*/
	...
	ApiDocument.prototype.GetRange = function(Start, End)
	{
		...
		/**
	 * Returns a Range object that represents the selected part of the document contained in the specified document.
	 * @typeofeditors ["CDE"]
	 * @param {Number} Start - start character in element
	 * @param {Number} End - end character in element 
	 * @return {ApiRange}
